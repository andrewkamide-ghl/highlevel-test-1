...
const navTabs = [
  ...
  { label: 'Agent Studio', active: false },
  { label: 'Voice AI', active: false },
  { label: 'Conversation AI', active: false },
  { label: 'Knowledge Base', active: false },
  { label: 'Agent Templates', active: false },
  ...
  return (
    <header className="header">
      <div className="header-left">
        ...
        <nav className="header-nav">
          {navTabs.map((tab) => (
            <button
              key={tab.label}
              className={`nav-tab ${tab.active ? 'nav-tab--active' : ''}`}
            >
              {tab.label}
            </button>
          ))}
      ...
      <div className="header-actions">
        <button className="action-btn action-btn--green" title="Phone">
          <PhoneIcon />
        </button>
        <button className="action-btn action-btn--blue" title="Upgrade">
          <SparkleIcon />
        </button>
        <button className="action-btn action-btn--green-robot" title="AI Assistant">
          <RobotIcon />
          <span className="badge badge--green">1</span>
        </button>
        <button className="action-btn action-btn--orange" title="Notifications">
          <BellIcon />
          <span className="badge badge--orange">3</span>
        </button>
        <button className="action-btn action-btn--blue-q" title="Help">
          <QuestionIcon />
        </button>
